...
{
  "dependencies": {
    "@meso.ai/types": "https://github.com/Grant-Huang/Meso/releases/download/v1.0.0/meso-types-1.0.0.tgz",
...
| `Module '"@meso.ai/ui"' has no exported member` | 类型声明与运行时版本不一致 | 确认 `@meso.ai/types` 与 `@meso.ai/ui` 版本配套，重新 install |
