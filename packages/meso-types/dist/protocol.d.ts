...
export declare const EXTENSION_PRESETS: Readonly<Record<string, PresetEntry>>;
export type PresetExtensionName = keyof typeof EXTENSION_PRESETS;
/** Type guard: is this name a preset OR an alias of one? */
export declare function isPresetExtension(name: string): name is PresetExtensionName;
