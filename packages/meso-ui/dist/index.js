...
import se, { useState as C, useRef as $, useEffect as E, useCallback as j, createContext as _e, useContext as te } from "react";
import { phaseRecordToStage as fe, createInitialStreamState as U, parseSSELine as pe, applyEvent as ve } from "./runtime.js";
...
function rr({
  ...
  const [g, y] = C(o), [R, O] = C(n), S = p !== void 0 ? p : R, b = () => {
    const w = !S;
    p === void 0 && O(w), h == null || h(w);
  };
  return /* @__PURE__ */ l("div", { className: "meso-layout", children: [
    /* @__PURE__ */ l("aside", { className: `meso-sidebar${g ? " meso-sidebar--collapsed" : ""}`, children: [
      ...
      /* @__PURE__ */ r("nav", { className: "meso-sidebar__nav", children: e.map((w) => /* @__PURE__ */ l(
        "div",
        {
          className: `meso-sidebar__nav-item${w.active ? " meso-sidebar__nav-item--active" : ""}`,
          onClick: w.onClick,
          title: w.label,
          children: [
            /* @__PURE__ */ r("span", { className: "meso-sidebar__nav-icon", children: w.icon }),
            /* @__PURE__ */ r("span", { className: "meso-sidebar__nav-label", children: w.label })
          ]
        },
        w.id
      )) }),
  ...
  return /* @__PURE__ */ l("div", { className: `meso-bubble meso-bubble--${e}`, children: [
    ...
    /* @__PURE__ */ l("div", { className: "meso-bubble__body", children: [
      i ? /* @__PURE__ */ r(
        ...
        t.split(`
`).map((d, f) => /* @__PURE__ */ l(se.Fragment, { children: [
          f > 0 && /* @__PURE__ */ r("br", {}),
          d
        ] }, f)),
...
function ae({
  ...
  const n = i !== void 0, [h, p] = C(c), [N, k] = C(null), v = $(null);
  v.current = N;
  const m = n ? i : N !== null ? N : h, _ = $(s), g = $(a), y = () => {
    const S = !m;
    n || k(S), d == null || d(S);
  };
  return E(() => {
    if (f !== "never" && o !== null) {
      if (_.current && !s) {
        const S = setTimeout(() => {
          n || p(!1), v.current === null && (d == null || d(!1));
        }, o);
    ...
    a !== void 0 && (g.current && !a && k(null), g.current = a);
  }, [a]), /* @__PURE__ */ l("div", { className: `meso-think${m ? " meso-think--open" : ""}`, children: [
    /* @__PURE__ */ l(
      "button",
      {
...
function Ne({
  ...
  const [u, n] = C(!1), [h, p] = C(e), [N, k] = C(null), [v, m] = C(!1), [_, g] = C(null), y = $("");
  E(() => {
    p(e);
  }, [e]), E(() => {
    e !== "mermaid" || a || !i || t === y.current || (y.current = t, k(null), m(!1), i(t).then((b) => k(b)).catch(() => m(!0)));
  }, [e, a, t, i]), E(() => {
    e !== "code" || a || !d || t === y.current && _ || (y.current = t, g(d(t, s)));
  }, [e, a, t, s, d, _]);
  const R = () => {
    navigator.clipboard.writeText(t).catch(() => {
    }), n(!0), setTimeout(() => n(!1), 2e3), o == null || o(t);
  }, O = () => {
    if (c) {
      c(t);
      return;
    ...
    const b = {
      ...
      table: "json",
      code: s || "txt"
    }, w = new Blob([t], { type: "text/plain" }), T = document.createElement("a");
    T.href = URL.createObjectURL(w), T.download = `artifact.${b[e]}`, T.click(), URL.revokeObjectURL(T.href);
  };
  return /* @__PURE__ */ l("div", { className: "meso-artifact", children: [
    /* @__PURE__ */ l("div", { className: "meso-artifact__header", children: [
      /* @__PURE__ */ r("div", { className: "meso-artifact__tabs", children: (e === "html" ? ["html", "code"] : [e]).map((b) => /* @__PURE__ */ r(
        "span",
        {
          className: `meso-artifact__tab${h === b ? " meso-artifact__tab--active" : ""}`,
          onClick: () => p(b),
          children: we(b, s)
        },
        b
      ...
      /* @__PURE__ */ r("button", { className: "meso-artifact__copy-btn", onClick: R, title: "复制", "aria-label": "复制代码", children: u ? /* @__PURE__ */ r("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ r("polyline", { points: "2,8 6,12 13,4" }) }) : /* @__PURE__ */ l("svg", { width: "15", height: "15", viewBox: "0 0 15 15", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
    ...
    /* @__PURE__ */ l("div", { className: "meso-artifact__body", children: [
      ...
      h === "mermaid" && /* @__PURE__ */ l(B, { children: [
        ...
        !a && !N && !v && !i && /* @__PURE__ */ l("div", { className: "meso-artifact__mermaid-placeholder", children: [
        ...
        !a && !N && !v && i && /* @__PURE__ */ r("div", { className: "meso-artifact__mermaid-placeholder", children: /* @__PURE__ */ r("span", { children: "渲染中…" }) })
      ] }),
      h === "markdown" && /* @__PURE__ */ r(B, { children: f ? /* @__PURE__ */ r(
        "div",
        {
      ...
      h === "table" && /* @__PURE__ */ r(ke, { content: t, streaming: a }),
      (h === "code" || h === "html" && !1) && /* @__PURE__ */ l("pre", { className: "meso-artifact__code", children: [
        _ && !a ? /* @__PURE__ */ r("code", { dangerouslySetInnerHTML: { __html: _ } }) : /* @__PURE__ */ r("code", { children: t }),
        a && /* @__PURE__ */ r("span", { className: "meso-artifact__cursor", "aria-hidden": "true", children: "▋" })
      ] })
    ] })
  ] });
}
function ke({ content: e, streaming: t }) {
  const s = ge(e);
  return s ? /* @__PURE__ */ r("div", { className: "meso-artifact__table-wrap", children: /* @__PURE__ */ l("table", { className: "meso-artifact__table", children: [
    /* @__PURE__ */ r("thead", { children: /* @__PURE__ */ r("tr", { children: s.headers.map((a, o) => /* @__PURE__ */ r("th", { children: a }, o)) }) }),
    /* @__PURE__ */ r("tbody", { children: s.rows.map((a, o) => /* @__PURE__ */ r("tr", { children: a.map((c, i) => /* @__PURE__ */ r("td", { children: String(c) }, i)) }, o)) })
  ] }) }) : /* @__PURE__ */ l("pre", { className: "meso-artifact__code", children: [
...
function xe({ stages: e, compact: t = !1 }) {
  return e.length === 0 ? null : /* @__PURE__ */ r("div", { className: `meso-stages${t ? " meso-stages--compact" : ""}`, role: "status", "aria-label": "处理进度", children: e.map((s, a) => /* @__PURE__ */ l(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ r("div", { className: "meso-stage__dot", children: /* @__PURE__ */ r(A, { status: be(s.status), size: 10 }) }),
...
function Ce(e) {
  ...
  for (const d of s) {
    ...
    const u = o.get(d);
    if (u) {
      const n = u.map((h) => t[h]).filter((h) => !!h);
      for (const h of n) i.add(h.node_id);
...
function Le({ node: e, isLast: t }) {
  var c;
  const [s, a] = C(!1), o = e.metadata && Object.keys(e.metadata).length > 0;
  return /* @__PURE__ */ l("div", { className: `meso-wf-node meso-wf-node--${e.state}`, children: [
    /* @__PURE__ */ l("div", { className: "meso-wf-node__track", children: [
      /* @__PURE__ */ r("div", { className: "meso-wf-node__dot", children: /* @__PURE__ */ r(ne, { state: e.state }) }),
    ...
    /* @__PURE__ */ l("div", { className: "meso-wf-node__body", children: [
      /* @__PURE__ */ l("div", { className: "meso-wf-node__header", children: [
        ...
        e.duration_ms !== void 0 && /* @__PURE__ */ r("span", { className: "meso-wf-node__duration", children: oe(e.duration_ms) }),
        o && /* @__PURE__ */ r(
          "button",
          {
      ...
      s && o && /* @__PURE__ */ r("pre", { className: "meso-wf-node__meta", children: JSON.stringify(e.metadata, null, 2) })
    ] })
  ] });
}
function $e({ nodes: e, isLast: t }) {
  return /* @__PURE__ */ l("div", { className: "meso-wf-parallel", children: [
    /* @__PURE__ */ r("div", { className: "meso-wf-parallel__row", children: e.map((s, a) => {
      ...
      return /* @__PURE__ */ l("div", { className: `meso-wf-parallel__branch meso-wf-parallel__branch--${s.state}`, children: [
        /* @__PURE__ */ r("div", { className: "meso-wf-parallel__branch-dot", children: /* @__PURE__ */ r(ne, { state: s.state }) }),
        /* @__PURE__ */ l("div", { className: "meso-wf-parallel__branch-body", children: [
          ...
          s.state === "error" && !!((o = s.metadata) != null && o.error) && /* @__PURE__ */ r("div", { className: "meso-wf-node__error", children: String(s.metadata.error) }),
          s.duration_ms !== void 0 && /* @__PURE__ */ r("span", { className: "meso-wf-node__duration", style: { display: "block", marginTop: 2 }, children: oe(s.duration_ms) })
        ] })
      ] }, s.node_id);
    }) }),
...
function Te({ runs: e, showRunId: t = !0, hidden: s }) {
  if (e.length === 0 || s) return null;
  const a = e.length > 1;
  return /* @__PURE__ */ r("div", { className: "meso-wf", role: "status", "aria-label": "工作流进度", children: e.map((o) => {
    const c = Ce(o);
    return /* @__PURE__ */ l("div", { className: "meso-wf-run", children: [
      a && t && /* @__PURE__ */ r("div", { className: "meso-wf-run__label", children: o.run_id }),
      c.map(
        (i, d) => i.kind === "parallel" ? /* @__PURE__ */ r($e, { nodes: i.nodes, isLast: i.isLast }, `parallel-${d}`) : /* @__PURE__ */ r(Le, { node: i.node, isLast: i.isLast }, i.node.node_id)
      )
    ] }, o.run_id);
  }) });
}
function Ee({ soul: e, compact: t = !1 }) {
...
function Oe({ skill: e }) {
  const t = e.provider ? Re[e.provider] : null;
  return /* @__PURE__ */ l(
    "div",
    {
...
function Ae({ toolCall: e, onConfirm: t, onCancel: s }) {
  const a = e.risk ?? "safe", o = Ie[a], c = Object.keys(e.args).length > 0;
  return /* @__PURE__ */ l("div", { className: `meso-confirm-gate meso-confirm-gate--${a}`, role: "alertdialog", "aria-label": "工具执行确认", "data-testid": "meso-confirm-gate", children: [
    ...
    /* @__PURE__ */ l("div", { className: "meso-confirm-gate__body", children: [
      /* @__PURE__ */ l("div", { className: "meso-confirm-gate__title", children: [
        /* @__PURE__ */ r("span", { className: `meso-confirm-gate__risk-badge meso-confirm-gate__risk-badge--${a}`, children: o.label }),
...
function De({ toolCall: e, onConfirm: t, onCancel: s, className: a, "data-testid": o }) {
  var k;
  const [c, i] = C(!1), [d, f] = C(!1), { call: u, result: n, status: h } = e, p = u.risk ?? "safe", N = Object.keys(u.args).length > 0;
  return /* @__PURE__ */ l(
    "div",
    {
      className: `meso-tool meso-tool--${h} meso-tool--risk-${p}${a ? ` ${a}` : ""}`,
      "data-testid": o ?? "meso-tool-call-block",
      children: [
        /* @__PURE__ */ l("div", { className: "meso-tool__header", children: [
          /* @__PURE__ */ r(A, { status: Me(h), size: 14, className: "meso-tool__status-icon" }),
          /* @__PURE__ */ r("span", { className: "meso-tool__name", children: u.name }),
          u.provider && re[u.provider] && /* @__PURE__ */ r("span", { className: `meso-tool__provider meso-tool__provider--${u.provider}`, children: re[u.provider] }),
          ((k = u.annotations) == null ? void 0 : k.open_world) && /* @__PURE__ */ r("span", { className: "meso-tool__annotation", title: "此工具会访问外部网络", children: "🌐" }),
          p !== "safe" && /* @__PURE__ */ r("span", { className: `meso-tool__risk meso-tool__risk--${p}`, children: je[p] }),
          (n == null ? void 0 : n.duration_ms) !== void 0 && /* @__PURE__ */ l("span", { className: "meso-tool__duration", children: [
            n.duration_ms,
            "ms"
          ] }),
          N && /* @__PURE__ */ l(
        ...
        h === "awaiting_confirm" && t && s && /* @__PURE__ */ r(
          Ae,
          {
            toolCall: u,
            onConfirm: t,
        ...
        (h === "done" || h === "error") && n && /* @__PURE__ */ l("div", { className: "meso-tool__result", children: [
          /* @__PURE__ */ l(
            "button",
            {
              className: "meso-tool__toggle",
          ...
          d && /* @__PURE__ */ r("pre", { className: `meso-tool__output${h === "error" ? " meso-tool__output--error" : ""}`, children: h === "error" ? n.error : n.output })
        ] })
      ]
    }
  );
}
function Pe({ resourceRead: e, className: t }) {
  const [s, a] = C(!1), { read: o, content: c, status: i } = e, d = o.name ?? o.uri, f = o.server;
  return /* @__PURE__ */ l("div", { className: `meso-resource meso-resource--${i}${t ? ` ${t}` : ""}`, children: [
    /* @__PURE__ */ l("div", { className: "meso-resource__header", children: [
      /* @__PURE__ */ r(A, { status: Be(i), size: 13, className: "meso-resource__status-icon" }),
      /* @__PURE__ */ r("span", { className: "meso-resource__uri", title: o.uri, children: d }),
    ...
    s && c && /* @__PURE__ */ r("div", { className: "meso-resource__content", children: i === "error" ? /* @__PURE__ */ r("pre", { className: "meso-resource__text meso-resource__text--error", children: c.error }) : c.contents.map((u, n) => /* @__PURE__ */ l("div", { children: [
      ...
      u.type === "blob" && /* @__PURE__ */ l("span", { className: "meso-resource__blob-label", children: [
        "[",
        u.mime_type ?? "binary",
        "]"
      ] })
...
function le({
  ...
  const [s, a] = C(null), o = $(e);
  return E(() => {
    t && !o.current && e && a(null), o.current = e;
  }, [e, t]), {
    open: s !== null ? s : e,
    setOpen: (i) => a(i),
...
function He(e) {
  ...
  for (const a of e.toolCallOrder) {
    const o = e.toolCalls[a];
    if (!o) continue;
    const c = o.groupId ? `${o.groupKind ?? "group"}:${o.groupId}` : `__single__:${a}`;
    t.has(c) || (t.set(c, {
      key: c,
      groupId: o.groupId,
...
function Ke(e) {
  const t = e.toolCallOrder.length + e.workflowRunOrder.reduce(
    (o, c) => {
      var i;
      return o + (((i = e.workflowRuns[c]) == null ? void 0 : i.nodeOrder.length) ?? 0);
    },
    0
  ), s = e.toolCallOrder.filter((o) => {
    var c;
    return ((c = e.toolCalls[o]) == null ? void 0 : c.status) === "error";
  }).length + e.workflowRunOrder.reduce((o, c) => {
    const i = e.workflowRuns[c];
    return i ? o + i.nodeOrder.filter((d) => {
      var f;
...
function Ue(e, t) {
  ...
  return /* @__PURE__ */ l("div", { className: "meso-process-trace__phase", "data-testid": `meso-phase-${e.id}`, children: [
    /* @__PURE__ */ l("div", { className: "meso-process-trace__phase-header", children: [
      /* @__PURE__ */ r(A, { status: We(e.state), size: 14 }),
...
function ze({
  ...
  const p = Ke(e), N = e.workflowRunOrder.map((m) => e.workflowRuns[m]).filter(Boolean), k = He(e), v = e.phaseOrder.map((m) => e.phases[m]).filter(Boolean).map(fe);
  return /* @__PURE__ */ l(
    "div",
    {
      className: `meso-process-trace${o ? ` ${o}` : ""}`,
      ...
      children: [
        ...
        n.open && /* @__PURE__ */ l("div", { className: "meso-process-trace__body", children: [
          v.length > 0 && /* @__PURE__ */ r(xe, { compact: !0, stages: v }),
          e.memorySnippets.length > 0 && /* @__PURE__ */ r("div", { className: "meso-memory-chips", children: e.memorySnippets.map((m, _) => /* @__PURE__ */ l("span", { className: "meso-memory-chip", title: m.content, children: [
            "[",
            m.category,
            "] ",
            m.content
          ...
          e.phaseOrder.length > 0 && /* @__PURE__ */ r("div", { className: "meso-process-trace__phases", children: e.phaseOrder.map((m) => {
            const _ = e.phases[m];
            if (!_) return null;
            const g = f == null ? void 0 : f(_);
            return g != null ? /* @__PURE__ */ r("div", { children: g }, m) : /* @__PURE__ */ r("div", { children: Ue(_, t) }, m);
          }) }),
          e.resourceReadOrder.length > 0 && /* @__PURE__ */ r("div", { className: "meso-process-trace__resources", children: e.resourceReadOrder.map((m) => {
            ...
            return _ ? /* @__PURE__ */ r(Pe, { resourceRead: _ }, m) : null;
          }) }),
          k.length > 0 && /* @__PURE__ */ r("div", { className: "meso-process-trace__tools", children: k.map((m) => /* @__PURE__ */ l(
            "div",
            {
              ...
              children: [
                m.groupId && /* @__PURE__ */ l("div", { className: "meso-process-trace__tool-group-label", children: [
                  m.groupKind ?? "group",
                  ": ",
                  m.groupId
                ] }),
                m.ids.map((_) => {
                  const g = e.toolCalls[_];
                  if (!g) return null;
                  const y = d == null ? void 0 : d(g);
                  return y != null ? /* @__PURE__ */ r("div", { children: y }, _) : /* @__PURE__ */ r(
                    De,
                    {
                      toolCall: g,
                      onConfirm: c,
          ...
          N.length > 0 && ((u == null ? void 0 : u(e)) ?? /* @__PURE__ */ r(Te, { runs: N }))
        ] })
      ]
    }
  );
...
function tr({
  ...
  E(() => {
    var _;
    (_ = v.current) == null || _.scrollIntoView({ behavior: "smooth" });
  }, [e, t]);
  const m = e.length > 0 || t && t.status !== "idle";
  return /* @__PURE__ */ r("div", { className: `meso-message-list${f ? ` ${f}` : ""}`, children: /* @__PURE__ */ l("div", { className: "meso-message-list__inner", children: [
    ...
    t && t.status !== "idle" && /* @__PURE__ */ r("div", { className: "meso-message-list__live", children: n ? n(t) : /* @__PURE__ */ l(B, { children: [
      (t.activeSoul || t.activeSkill) && /* @__PURE__ */ l("div", { className: "meso-message-list__context-row", children: [
        t.activeSoul && /* @__PURE__ */ r(Ee, { soul: t.activeSoul }),
        t.activeSkill && /* @__PURE__ */ r(Oe, { skill: t.activeSkill })
      ] }),
      /* @__PURE__ */ r(
        ze,
        {
      ...
      u && t.extensionLog.length > 0 && /* @__PURE__ */ r("div", { className: "meso-message-list__extensions", children: t.extensionLog.map((_, g) => /* @__PURE__ */ r(se.Fragment, { children: u(_) }, g)) }),
      ...
      t.artifactOrder.map((_) => {
        const g = t.artifacts[_];
        if (!g || k != null && k.includes(g.lang)) return null;
        const { type: y, language: R } = Ve(g.lang);
        return /* @__PURE__ */ r(
          Ne,
          {
            type: y,
      ...
      t.memorySaved.length > 0 && /* @__PURE__ */ r("div", { className: "meso-memory-saved", children: t.memorySaved.map((_) => /* @__PURE__ */ l("span", { className: "meso-memory-saved__chip", title: _.preview, children: [
...
function ar({
  ...
  const n = $(null), h = 22, p = () => {
    const m = n.current;
    m && (m.style.height = "auto", m.style.height = Math.min(m.scrollHeight, h * u) + "px");
  };
  E(p, [e]);
  const N = (m) => {
    m.key === "Enter" && (m.ctrlKey || m.metaKey) && (m.preventDefault(), !c && !o && e.trim() && s());
  }, k = !c && !o && e.trim().length > 0, v = /* @__PURE__ */ r(
    "button",
    {
      className: `meso-composer__send${o ? " meso-composer__send--stop" : ""}`,
      onClick: o ? a : s,
      disabled: o ? !1 : !k,
      "aria-label": o ? "停止生成" : "发送",
      title: o ? "停止生成" : "Ctrl+Enter",
      children: o ? (
        /* Stop square */
  ...
  return /* @__PURE__ */ r("div", { className: "meso-composer", children: /* @__PURE__ */ l("div", { className: "meso-composer__box", children: [
    ...
    /* @__PURE__ */ l("div", { className: "meso-composer__toolbar", children: [
      ...
      /* @__PURE__ */ r("div", { className: "meso-composer__trailing", children: f ?? v })
    ] })
  ] }) });
}
function nr({
  ...
  E(() => {
    if (!c) return;
    const n = (h) => {
      d.current && !d.current.contains(h.target) && i(!1);
    };
    return document.addEventListener("mousedown", n), () => document.removeEventListener("mousedown", n);
  }, [c]);
  const f = s ?? e.charAt(0).toUpperCase(), u = [
    ...a,
    ...o ? [{ label: "退出登录", onClick: () => {
      i(!1), o();
    }, danger: !0 }] : []
  ];
  return /* @__PURE__ */ l("div", { className: "meso-user-menu", ref: d, children: [
...
function or({
  ...
  var h;
  const o = t !== void 0, [c, i] = C(((h = e[0]) == null ? void 0 : h.id) ?? ""), d = o ? t : c, f = $(!1);
  E(() => {
    if (!a || f.current) return;
    const p = e.find((N) => N.ready);
    p && (f.current = !0, o || i(p.id), s == null || s(p.id));
  }, [e, a, o, s]);
  const u = (p) => {
    o || i(p), s == null || s(p);
  }, n = e.find((p) => p.id === d) ?? e[0];
  return e.length === 0 ? null : /* @__PURE__ */ l("div", { className: "meso-artifact-shell", children: [
    /* @__PURE__ */ r("div", { className: "meso-artifact-shell__tabs", role: "tablist", children: e.map((p) => /* @__PURE__ */ l(
      "button",
      {
        role: "tab",
...
function lr({ status: e, primary: t, outcome: s, detail: a, className: o, "data-testid": c }) {
  const i = a !== void 0 && a !== "", d = le({ system: !1 });
  return /* @__PURE__ */ l("div", { className: `meso-log-line${o ? ` ${o}` : ""}`, "data-testid": c ?? "meso-log-line", children: [
    /* @__PURE__ */ l(
      "div",
      {
...
function Fe(e, t, s) {
  var a, o, c, i, d, f, u, n, h, p, N, k, v, m, _, g;
  if (s)
    switch (e.type) {
      case "capabilities":
        ...
        break;
      case "phase":
        (o = s.onPhaseChange) == null || o.call(s, e.payload);
        break;
      case "memory":
      ...
      case "think":
        ...
        break;
      case "artifact": {
        const y = t.artifacts[e.payload.id];
        y && ((v = s.onArtifact) == null || v.call(s, y));
        break;
      }
      case "extension":
      ...
      case "error":
        ...
        break;
      case "done":
        (g = s.onDone) == null || g.call(s, t);
        break;
    }
}
function ir(e, t) {
  const [s, a] = C(U), o = $(null), c = $(!1), i = $(t);
  i.current = t;
  const d = j(() => {
    var n;
    (n = o.current) == null || n.abort(), c.current = !1, a((h) => ({ ...h, status: "idle" }));
  }, []), f = j(() => {
    var n;
    (n = o.current) == null || n.abort(), c.current = !1, a(U());
  }, []), u = j(async (n) => {
    var _, g, y, R, O, S;
    if (c.current) return;
    c.current = !0;
    const h = typeof (n == null ? void 0 : n.reconnect) == "object" ? n.reconnect : { maxAttempts: 3, baseDelayMs: 1e3 }, p = n != null && n.reconnect ? h.maxAttempts ?? 3 : 0, N = h.baseDelayMs ?? 1e3, k = (n == null ? void 0 : n.batchMs) === void 0 ? 16 : n.batchMs;
    let v = 0;
    const m = async () => {
      var Y;
      (Y = o.current) == null || Y.abort();
      const b = new AbortController();
      o.current = b;
      const w = { ...U(), status: "streaming" };
      a(w);
      let T = w;
      const V = (n == null ? void 0 : n.method) ?? (n != null && n.body ? "POST" : "GET"), D = (n == null ? void 0 : n.watchdogMs) === void 0 ? 12e4 : n.watchdogMs;
      let P = null;
      const H = () => {
        P && clearTimeout(P);
      }, G = () => {
      ...
      const F = (x) => {
        const L = ve(T, x);
        if (T = L, a(L), Fe(x, L, i.current), x.type === "done" || x.type === "error")
          return H(), x.type;
      }, J = () => {
        for (; K.length > 0; ) {
          const x = K.shift(), L = F(x);
          if (L) return L;
        }
      }, de = (x) => {
      ...
      try {
        ...
        let M = "";
        for (G(); ; ) {
          const { done: me, value: ue } = await L.read();
          if (me) break;
          G(), M += W.decode(ue, { stream: !0 });
          const q = M.split(`
`);
          M = q.pop() ?? "";
          for (const he of q) {
    ...
    try {
      for (; ; ) {
        try {
          ...
          if (!(n != null && n.reconnect) || v >= p) {
            const w = "SSE stream ended unexpectedly";
            a((T) => ({ ...T, status: "error", errorMessage: w, errorCode: "STREAM_ENDED" })), (g = (_ = i.current) == null ? void 0 : _.onError) == null || g.call(_, w, "STREAM_ENDED");
            return;
          }
        } catch (b) {
          if (!(n != null && n.reconnect) || v >= p) {
            const w = b.message;
            a((T) => ({ ...T, status: "error", errorMessage: w })), (R = (y = i.current) == null ? void 0 : y.onError) == null || R.call(y, w);
            return;
          }
        }
        v += 1, (S = (O = i.current) == null ? void 0 : O.onReconnect) == null || S.call(O, v), await new Promise((b) => setTimeout(b, N * Math.pow(2, v - 1)));
      }
    } finally {
      c.current = !1;
    }
...
const ie = "meso-theme";
function Je() {
  return typeof window > "u" ? "light" : localStorage.getItem(ie) ?? "light";
}
function Ye(e) {
  document.documentElement.setAttribute("data-theme", e), localStorage.setItem(ie, e);
}
function cr() {
  const [e, t] = C(Je);
  E(() => {
...
function dr({
  ...
  const a = { ...qe[e], ...t };
  return /* @__PURE__ */ r(z.Provider, { value: { locale: e, labels: a }, children: s });
}
function mr() {
  return te(z).labels;
}
...
export {
  ...
  ze as ProcessTrace,
  Pe as ResourceReadBlock,
  nr as SidebarUserMenu,
  Oe as SkillIndicator,
  Ee as SoulIndicator,
  xe as StageTimeline,
  A as StatusIcon,
